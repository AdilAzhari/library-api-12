                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <select v-model="form.book_id" id="book_id" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#2c3e50] focus:border-[#2c3e50] sm:text-sm">
                            ...
                            <div>
                                ...
                                <select v-model="form.user_id" id="user_id" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#2c3e50] focus:border-[#2c3e50] sm:text-sm">
                            ...
                            <div>
                                <label for="borrowed_at" class="block text-sm font-medium text-gray-700">Borrow Date</label>
                                <input v-model="form.borrowed_at" type="date" id="borrowed_at" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#2c3e50] focus:border-[#2c3e50] sm:text-sm">
                                <p v-if="form.errors.borrowed_at" class="mt-2 text-sm text-red-600">{{ form.errors.borrowed_at }}</p>
                            </div>

                            <div>
                                <label for="due_date" class="block text-sm font-medium text-gray-700">Due Date *</label>
                                <input v-model="form.due_date" type="date" id="due_date" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#2c3e50] focus:border-[#2c3e50] sm:text-sm">
                                <p v-if="form.errors.due_date" class="mt-2 text-sm text-red-600">{{ form.errors.due_date }}</p>
                            </div>
                        </div>
                    </div>
